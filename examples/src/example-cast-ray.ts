...
const faint = new THREE.MeshBasicMaterial( { color: 0xffffff, transparent: true, opacity: 0.25 } );

type Caster = { root: THREE.Object3D; hitMesh: THREE.Mesh; cyl: THREE.Mesh; quat: THREE.Quaternion; spin: THREE.Vector3 };
